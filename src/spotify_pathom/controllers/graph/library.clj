...
(defn albums [env _]
  (-> {::api/endpoint (str "me/albums")}
      ...
      (api/paged-result :spotify.me/albums)))

(graph/add-resolver! `albums
  {::p.connect/output [#:spotify.me{:albums [:added_at
                                             {:album [:spotify.album/album-type
                                                      :spotify.album/release-date
                                                      :spotify.album/available-markets
                                                      #:spotify.album{:tracks [:href
                                                                               {:items [:spotify.track/preview-url
                                                      ...
                                                      :spotify.album/release-date-precision
                       ...
                       #:spotify.me{:albums-page [:href :limit :next :offset :previous :total]}]})
...
(defn tracks [env _]
  (-> {::api/endpoint (str "me/tracks")}
      ...
      (api/paged-result :spotify.me/tracks)))

(graph/add-resolver! `tracks
  {::p.connect/output [#:spotify.me{:tracks [:added_at
                                             {:track [:spotify.track/preview-url
                                                      ...
                                                      #:spotify.track{:external-urls [:spotify]}
                                                      :spotify.track/id]}]}
                       #:spotify.me{:tracks-page [:href :limit :next :offset :previous :total]}]})
